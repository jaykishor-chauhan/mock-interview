...
function CheckPermissions() {
  ...
  const { active, url, interviewQuestions, interviewCategory, interviewCourse } = location.state || {};
            ...
            <div className="pt-4">
              {allSetupComplete ? (
                <div className="p-4 bg-green-500/10 border border-green-400 rounded-lg text-center flex flex-col items-center gap-2">
                  ...
                  <button
                    onClick={() => navigate(url, { state: { interviewQuestions, interviewCategory, interviewCourse } })}
