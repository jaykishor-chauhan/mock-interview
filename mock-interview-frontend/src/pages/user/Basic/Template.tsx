...
import heroImage from "../../../assets/hero-interview-01.jpg";
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <FeatureCard
              ...
              description="The tools and expertise you need to prepare for your interview with confidence."
              linkText="Practice now →"
            />
            <FeatureCard
              image={analyticsIcon}
              title="Scale with confidence"
              description="Practice on a world-class platform that helps thousands improve their interview skills every month."
              linkText="Send & grow →"
            />
            <FeatureCard
              image={feedbackIcon}
              title="Interview expertise"
              description="Experts can help you optimize your performance, troubleshoot, and resolve issues."
              linkText="Work with experts →"
            />
          </div>
        </div>
      </section>
...
const FeatureCard = ({ image, title, description, linkText }: any) => (
