        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed hidden lg:block">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                {token && (
                  <Button onClick={ ()=> navigate('/interviews') } size="lg" className="w-full sm:w-auto bg-white text-primary hover:bg-white/90 group">
                    Start Interview
                    <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Button>
                )}
                <Button onClick={ ()=> navigate('/interview-sampling') } size="lg" variant="outline" className="w-full sm:w-auto border-white/20 text-primary hover:bg-white/10">
