...
import { Search, Book, Code, ArrowRight, ChevronDown, ChevronUp, BookOpen, ExternalLink, Coffee } from "lucide-react";
         ...
         <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-700 text-white py-12">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
               <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                     <h1 className="text-4xl font-bold">Java Technical Interview Questions</h1>
                     <p className="text-orange-100 mt-2">Comprehensive guide to ace your Java interviews with confidence</p>
                  </div>
               </div>
               ...
               <div className="flex gap-6 mt-6">
                  ...
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                     ...
                     <span className="text-sm font-medium">From Basics to Advanced</span>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                  <div className="flex flex-col md:flex-row gap-4">
                     ...
                     <div className="flex-1 relative">
                        ...
                        <Input
                           placeholder="Search topics or keywords (e.g., 'JVM', 'String Pool', 'static')..."
                           value={query}
